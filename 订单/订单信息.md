...
<table>
    ...
    <tr>
        <td>customizeStatus</td>
        <td>int</td>
        <td>-</td>
        <td>定制状态</td>
        <td>定制中: 10 100: 定制完成</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>-</td>
        <td>状态</td>
        <td>待付款: 10 定制中: 10 配镜中: 20 待取货: 90 完成: 100 取消:0</td>
    </tr>
    <tr>
        <td>completeAt</td>
        <td>int</td>
...
<table>
    ...
    <tr>
        ...
        <td>-</td>
        <td>状态</td>
        <td>取消: 0 定制中: 10 配镜中: 0 可取货: 90 完成: 100</td>
    </tr>
    <tr>
        <td>readyAt</td>
        <td>int</td>
...
> 参数: orderId: 订单ID orderProductId: 订单商品ID, make: 是否配镜, 1:是 0:否
